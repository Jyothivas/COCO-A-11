const Palindrome = require('../../lib/assignment/Palindrome');

describe('palindrome check',function(){
    it('Find if a string is a palindrome',function(){
        const palindrome = new Palindrome();
        expect(palindrome.isPalindrome('')).toEqual('Enter valid string');
        expect(palindrome.isPalindrome('a')).toEqual('Enter valid string');
